...
# Example usage:
input_path = 'img/winlab.jpg'  # Replace with your input image path
output_path = 'img/winlab.jpg'  # Replace with your desired output image path
crop_image_to_ratio(input_path, output_path, 1, 1)
